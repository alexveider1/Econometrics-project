# Влияние высшего образования на здоровье: три подхода к причинно-следственному выводу
...
Данный проект воспроизводит и расширяет исследование Е. Коссовой и М. Косоруковой [«Оценивание влияния высшего образования на здоровье: сравнение многомерной рекурсивной пробит-модели и мэтчинга»](/data/article.pdf), применяя три независимых подхода к идентификации причинно-следственного эффекта.
...
Анализ проводится раздельно для **мужчин** (1 926 наблюдений) и **женщин** (2 672 наблюдения) по **16 нозологическим группам** и интегральному показателю самооценки здоровья.

---

## Методы

Все три метода применяются к одним и тем же данным, что позволяет верифицировать устойчивость результатов.

### 1 Двухшаговая рекурсивная пробит-модель
