...
|---|---|---|
| **PSM** | Logit-пропенсити + caliper 0.2σ | Уравновешивание в логит-пространстве склонности |
| **Mahalanobis** | Расстояние Махаланобиса | Учитывает ковариационную структуру признаков |
...
### 3 Double ML (DoubleMLIRM)

Двойная машинная регрессия на основе Interactive Regression Model. Метод Робинсона–Чернозукова–Демирера–Хансена позволяет устранить влияние ковариат (возраст, тип населённого пункта, инвалидность) без параметрических предположений о функциональной форме.
...
- Визуализация: forest-plot и volcano-plot по всем 15 исходам
